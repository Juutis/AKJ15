...
public static class SoftScienceTexts
{
    public static List<string> Texts = new List<string>()
    {
        "The basis of conditioning is formed by the idea that human behavior is learned.",
        "Memory involves cognitive processes such as thinking, knowing, remembering, judging, and problem-solving.",
        "Cultural studies seeks to understand how cultural practices relate to systems of power via social phenomena.",
        "Disruptions to the societal norms can serve to highlight their limitations and challenge them in the process.",
